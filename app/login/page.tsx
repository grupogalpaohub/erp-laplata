      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
          ...
          <div className="opacity-60 pointer-events-none select-none">
            <button className="w-full inline-flex items-center justify-center px-6 py-4 bg-white text-fiori-primary font-semibold rounded-xl shadow-lg" disabled>
            ...
            <p className="mt-2 text-sm text-center text-white/70">
              A autenticação está desligada neste ambiente local.
            </p>
          </div>
