  ...
  const addItem = () => {
    ...
    newItem.innerHTML = `
      ...
      <div>
        ...
        <input type="number" name="unit_prices[]" required step="0.01" min="0" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="0.00" />
      </div>
