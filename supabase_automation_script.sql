-- =====================================================
-- SCRIPT DE AUTOMAÇÃO DE ESTOQUE E FINANCEIRO
-- Execute este script no Supabase Dashboard > SQL Editor
-- =====================================================

-- 1. Verificar se a função next_doc_number existe, se não criar uma simples
...
-- 3. Função FI para recebimentos de compra
...
-- 4. Trigger para recebimentos de compra
...
-- 6. Trigger para reserva de estoque em pedidos de venda
...
-- 7. Trigger para baixa de estoque em expedições
...
-- 11. Processar dados existentes (backfill)
...
-- 12. Verificar se as tabelas necessárias existem e criar se necessário
-- Adicionar campos que podem estar faltando

-- Adicionar campo updated_at em wh_inventory_balance se não existir
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Adicionar campos de lead time e estoque em mm_material se não existirem
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
...
SELECT 'Sistema de automação de estoque e financeiro implementado com sucesso!' as status;
